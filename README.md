...
### Then, Customize data in the `utils/data` [folder](https://github.com/Hey-SauravGupta/developer-portfolio/tree/main/utils/data).
...
export const personalData = {
  name: "Saurav Kumar",
  profile: "/profile.png",
  designation: "Full-Stack Full Stack Web Developer",
  description: "My name is Saurav Kumar....",
